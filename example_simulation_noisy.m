...
%The is the result of Figure 10, subfigures from (f) to (i) (i.e when there
%is noise).
...
for jjj=[0]
    ...
    %This part is used to add noise as a gaussian random vector of zero
    %mean and standard deviation 0.35
    for jj=16:10:235
        Imm1(:,jj)=Imm1(:,jj)+0.35*randn(1041,1);
        Imm2(:,jj)=Imm2(:,jj)+0.35*randn(1041,1);
    end
