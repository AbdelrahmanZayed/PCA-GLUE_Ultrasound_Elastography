...
for jjj=[1]
    ...
    i       
    s
    load(['invivo_2_after_' num2str(jjj) '.mat'])
    exist RfDataDouble;
    ex1=ans;
    if ex1==1
    ...
    load(['invivo_2_after_' num2str(i+jjj) '.mat'])
    exist RfDataDouble;
    ex2=ans;
    if ex2==1
    RfDataDouble=double(RfDataDouble);
...
%      colorbar
    ...
    figure;
    imagesc([0 xRat*(endA-startA)],yRat*[startRF endRF],BMODE1); set(gca,'fontsize',60);
    colormap(gray);xlabel('width (mm)','fontsize',60); ylabel('depth (mm)','fontsize',60);
    ...
    figure;
    imagesc([0 xRat*(endA-startA)],yRat*[startRF endRF],strain7(1:end-250,:)); set(gca,'fontsize',60);
    colormap(gray);xlabel('width (mm)','fontsize',60); ylabel('depth (mm)','fontsize',60);
%     colorbar
