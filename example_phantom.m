...
for jjj=[359]
    ...
    colorbar 
    colormap(hot);xlabel('width (mm)','fontsize',53); ylabel('depth (mm)','fontsize',53);
...
%     colorbar
    ...
    xRat = (40.8-2.5)/w_a;
    yRat = 42.95/2233;
    wDIff = 71; % window length of the differentiation kernel
    disp4=imresize(disp4,[2224,354],'bilinear');
