...
<p style="text-align: center;"> <b>Figure:</b> We first decompose the displacement image between 2 frames into a linear sum of 12 pre-copmuted pricinpal components. We then use the weights of these components as features to a classifier to determine the suitablity of the frame pair. </p>
</div>
